...
<div>
  <h1 class="bg-[#14b321] text-white px-4 py-2 font-bold rounded-md">Quarterly Archive</h1>
  @foreach ($archives as $archive)
    ...
    ]) }}" class="flex items-center gap-2 hover:text-[#14b321] px-4 py-2 border-b border-slate-300">
